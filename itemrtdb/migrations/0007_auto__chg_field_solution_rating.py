...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Solution.rating'
        db.alter_column(u'itemrtdb_solution', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Solution.rating'
        db.alter_column(u'itemrtdb_solution', 'rating', self.gf('django.db.models.fields.IntegerField')(default=5))
    ...
    models = {
        ...
        u'itemrtdb.question': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marks': ('django.db.models.fields.DecimalField', [], {'default': '1.0', 'max_digits': '3', 'decimal_places': '1'}),
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': u"orm['itemrtdb.Topic']"}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['itemrtdb.Type']"})
        },
