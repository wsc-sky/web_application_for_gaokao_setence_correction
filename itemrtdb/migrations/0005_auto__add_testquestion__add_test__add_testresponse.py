...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'itemrtdb_testquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['itemrtdb.Question'])),
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['itemrtdb.Test'])),
        ))
        db.send_create_signal(u'itemrtdb', ['TestQuestion'])

        # Adding model 'Test'
        db.create_table(u'itemrtdb_test', (
        ...
        db.send_create_signal(u'itemrtdb', ['Test'])

        # Adding model 'TestResponse'
        db.create_table(u'itemrtdb_testresponse', (
            (u'response_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['itemrtdb.Response'], unique=True, primary_key=True)),
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', to=orm['itemrtdb.Test'])),
        ))
        db.send_create_signal(u'itemrtdb', ['TestResponse'])


    def backwards(self, orm):
        # Deleting model 'TestQuestion'
        db.delete_table(u'itemrtdb_testquestion')

        # Deleting model 'Test'
        db.delete_table(u'itemrtdb_test')

        # Deleting model 'TestResponse'
        db.delete_table(u'itemrtdb_testresponse')
