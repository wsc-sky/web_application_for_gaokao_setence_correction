...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.mark'
        db.delete_column(u'itemrtdb_question', 'mark')

        # Adding field 'Question.marks'
        db.add_column(u'itemrtdb_question', 'marks',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Deleting field 'Response.correct'
        db.delete_column(u'itemrtdb_response', 'correct')

        # Adding field 'Response.correctness'
        db.add_column(u'itemrtdb_response', 'correctness',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Question.mark'
        db.add_column(u'itemrtdb_question', 'mark',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Deleting field 'Question.marks'
        db.delete_column(u'itemrtdb_question', 'marks')

        # Adding field 'Response.correct'
        db.add_column(u'itemrtdb_response', 'correct',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Response.correctness'
        db.delete_column(u'itemrtdb_response', 'correctness')
