...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.ability'
        db.alter_column(u'itemrtdb_response', 'ability', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Response.ability'
        db.alter_column(u'itemrtdb_response', 'ability', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=4))
